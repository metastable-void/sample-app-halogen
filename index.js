(() => {
  ...
  var render = function(state3) {
    ...
    })])([text5("-")]), div2([])([text5(showState(state3))]), button([onClick(function(v) {
      return Increment.value;
    })])([text5("+")]), button([onClick(function(v) {
      return Reset.value;
    })])([text5("Reset")])]);
  };
  ...
  var handleAction = function(dictMonadState) {
    ...
    return function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 49, column 16 - line 55, column 40): " + [v.constructor.name]);
    };
  };
